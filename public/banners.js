...
var banners_list = [0, 1];

setInterval(function(){
  var banner = rr(banners_list);
  banners_list.forEach(function (b) {
      $('.banners .banner')[b].style.display = 'none';
  })
  $('.banners .banner')[banner].style.display = 'block';
}, 5200);