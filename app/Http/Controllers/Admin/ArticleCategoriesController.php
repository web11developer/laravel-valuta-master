...
class ArticleCategoriesController extends AdminController {
    ...
    public function data()
    {
        ...
        return Datatables::of($article_categories)
           ->addColumn('actions', '<a href="{{{ URL::to(\'admin/articlecategory/\' . $id . \'/edit\' ) }}}" class="btn btn-success btn-sm" ><span class="glyphicon glyphicon-pencil"></span>  {{ trans("admin/modal.edit") }}</a>
                <a href="{{{ URL::to(\'admin/articlecategory/\' . $id . \'/delete\' ) }}}" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span> {{ trans("admin/modal.delete") }}</a>
